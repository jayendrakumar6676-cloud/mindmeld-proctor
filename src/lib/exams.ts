...
const systemQuestions: Question[] = [
  ...
  Q(17, "You have 4 Redis cache servers. You route keys based on hash(key) % 4. Server #4 crashes. The algorithm changes to hash(key) % 3. Suddenly, 75% of your cached keys route to the wrong servers, causing a massive cache miss. Which concept solves this by mapping nodes and keys to a virtual ring, 
